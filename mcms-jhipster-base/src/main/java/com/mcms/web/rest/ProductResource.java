...
import com.mcms.repository.ProductRepository;
...
/**
 * REST controller for managing {@link com.mcms.domain.Product}.
 */
@RestController
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getDefaultGrade() != null) {
                    existingProduct.setDefaultGrade(product.getDefaultGrade());
                }
                if (product.getDefaultWeightKg() != null) {
                    existingProduct.setDefaultWeightKg(product.getDefaultWeightKg());
                }
                if (product.getDefaultPricePerKg() != null) {
                    existingProduct.setDefaultPricePerKg(product.getDefaultPricePerKg());
                }
