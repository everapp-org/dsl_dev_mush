...
/**
 * REST controller for managing {@link com.mcms.domain.Customer}.
 */
@RestController
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getDeliveryPreference() != null) {
                    existingCustomer.setDeliveryPreference(customer.getDeliveryPreference());
                }
