...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HARVESTRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HARVESTRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HARVESTRECORD actions', async () => {
      const arg = { id: 23367 };
    ...
    it('dispatches UPDATE_HARVESTRECORD actions', async () => {
      const arg = { id: 23367 };
    ...
    it('dispatches PARTIAL_UPDATE_HARVESTRECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HARVESTRECORD actions', async () => {
      const arg = 42666;
