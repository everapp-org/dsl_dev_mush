...
import reducer, {
  ...
  reset,
  updateEntity,
} from './batch-material-usage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATCHMATERIALUSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BATCHMATERIALUSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BATCHMATERIALUSAGE actions', async () => {
      const arg = { id: 26799 };
    ...
    it('dispatches UPDATE_BATCHMATERIALUSAGE actions', async () => {
      const arg = { id: 26799 };
    ...
    it('dispatches PARTIAL_UPDATE_BATCHMATERIALUSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BATCHMATERIALUSAGE actions', async () => {
      const arg = 42666;
