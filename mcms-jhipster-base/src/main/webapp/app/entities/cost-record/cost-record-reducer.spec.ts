...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COSTRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COSTRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COSTRECORD actions', async () => {
      const arg = { id: 10089 };
    ...
    it('dispatches UPDATE_COSTRECORD actions', async () => {
      const arg = { id: 10089 };
    ...
    it('dispatches PARTIAL_UPDATE_COSTRECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COSTRECORD actions', async () => {
      const arg = 42666;
