...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IMonthlyReport> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONTHLYREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MONTHLYREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MONTHLYREPORT actions', async () => {
      const arg = { id: 1815 };
    ...
    it('dispatches UPDATE_MONTHLYREPORT actions', async () => {
      const arg = { id: 1815 };
    ...
    it('dispatches PARTIAL_UPDATE_MONTHLYREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MONTHLYREPORT actions', async () => {
      const arg = 42666;
