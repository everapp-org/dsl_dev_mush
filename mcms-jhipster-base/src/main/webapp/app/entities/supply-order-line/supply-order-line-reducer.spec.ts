...
import reducer, {
  ...
  reset,
  updateEntity,
} from './supply-order-line.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLYORDERLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLYORDERLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLYORDERLINE actions', async () => {
      const arg = { id: 19609 };
    ...
    it('dispatches UPDATE_SUPPLYORDERLINE actions', async () => {
      const arg = { id: 19609 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLYORDERLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLYORDERLINE actions', async () => {
      const arg = 42666;
