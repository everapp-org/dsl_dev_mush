...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHASEEXECUTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHASEEXECUTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHASEEXECUTION actions', async () => {
      const arg = { id: 18288 };
    ...
    it('dispatches UPDATE_PHASEEXECUTION actions', async () => {
      const arg = { id: 18288 };
    ...
    it('dispatches PARTIAL_UPDATE_PHASEEXECUTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PHASEEXECUTION actions', async () => {
      const arg = 42666;
