...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSTRATERECIPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSTRATERECIPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSTRATERECIPE actions', async () => {
      const arg = { id: 5163 };
    ...
    it('dispatches UPDATE_SUBSTRATERECIPE actions', async () => {
      const arg = { id: 5163 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSTRATERECIPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSTRATERECIPE actions', async () => {
      const arg = 42666;
