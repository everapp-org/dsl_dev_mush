...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTORYLOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVENTORYLOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVENTORYLOT actions', async () => {
      const arg = { id: 9207 };
    ...
    it('dispatches UPDATE_INVENTORYLOT actions', async () => {
      const arg = { id: 9207 };
    ...
    it('dispatches PARTIAL_UPDATE_INVENTORYLOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVENTORYLOT actions', async () => {
      const arg = 42666;
