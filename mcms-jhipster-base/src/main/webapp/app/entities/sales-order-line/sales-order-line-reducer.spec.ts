...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESORDERLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SALESORDERLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SALESORDERLINE actions', async () => {
      const arg = { id: 975 };
    ...
    it('dispatches UPDATE_SALESORDERLINE actions', async () => {
      const arg = { id: 975 };
    ...
    it('dispatches PARTIAL_UPDATE_SALESORDERLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SALESORDERLINE actions', async () => {
      const arg = 42666;
