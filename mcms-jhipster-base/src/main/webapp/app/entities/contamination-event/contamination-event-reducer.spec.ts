...
import reducer, {
  ...
  reset,
  updateEntity,
} from './contamination-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTAMINATIONEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTAMINATIONEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTAMINATIONEVENT actions', async () => {
      const arg = { id: 23857 };
    ...
    it('dispatches UPDATE_CONTAMINATIONEVENT actions', async () => {
      const arg = { id: 23857 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTAMINATIONEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTAMINATIONEVENT actions', async () => {
      const arg = 42666;
