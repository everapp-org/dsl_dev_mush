...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './strain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRAIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRAIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRAIN actions', async () => {
      const arg = { id: 30272 };
    ...
    it('dispatches UPDATE_STRAIN actions', async () => {
      const arg = { id: 30272 };
    ...
    it('dispatches PARTIAL_UPDATE_STRAIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRAIN actions', async () => {
      const arg = 42666;
