...
export const createEntity = createAsyncThunk(
  'strain/create_entity',
  async (entity: IStrain, thunkAPI) => {
    const result = await axios.post<IStrain>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'strain/update_entity',
  async (entity: IStrain, thunkAPI) => {
    const result = await axios.put<IStrain>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  'strain/partial_update_entity',
  async (entity: IStrain, thunkAPI) => {
    const result = await axios.patch<IStrain>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  'strain/delete_entity',
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IStrain>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
