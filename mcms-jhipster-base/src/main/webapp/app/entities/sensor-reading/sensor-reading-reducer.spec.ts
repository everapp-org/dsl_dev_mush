...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENSORREADING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SENSORREADING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SENSORREADING actions', async () => {
      const arg = { id: 18523 };
    ...
    it('dispatches UPDATE_SENSORREADING actions', async () => {
      const arg = { id: 18523 };
    ...
    it('dispatches PARTIAL_UPDATE_SENSORREADING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SENSORREADING actions', async () => {
      const arg = 42666;
