...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLYORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLYORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLYORDER actions', async () => {
      const arg = { id: 24022 };
    ...
    it('dispatches UPDATE_SUPPLYORDER actions', async () => {
      const arg = { id: 24022 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLYORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLYORDER actions', async () => {
      const arg = 42666;
