...
import reducer, {
  ...
  reset,
  updateEntity,
} from './mandatory-field-check.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANDATORYFIELDCHECK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MANDATORYFIELDCHECK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MANDATORYFIELDCHECK actions', async () => {
      const arg = { id: 15999 };
    ...
    it('dispatches UPDATE_MANDATORYFIELDCHECK actions', async () => {
      const arg = { id: 15999 };
    ...
    it('dispatches PARTIAL_UPDATE_MANDATORYFIELDCHECK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MANDATORYFIELDCHECK actions', async () => {
      const arg = 42666;
