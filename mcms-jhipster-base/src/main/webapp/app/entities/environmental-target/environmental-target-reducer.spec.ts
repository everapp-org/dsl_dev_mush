...
import reducer, {
  ...
  reset,
  updateEntity,
} from './environmental-target.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENVIRONMENTALTARGET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENVIRONMENTALTARGET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENVIRONMENTALTARGET actions', async () => {
      const arg = { id: 18529 };
    ...
    it('dispatches UPDATE_ENVIRONMENTALTARGET actions', async () => {
      const arg = { id: 18529 };
    ...
    it('dispatches PARTIAL_UPDATE_ENVIRONMENTALTARGET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENVIRONMENTALTARGET actions', async () => {
      const arg = 42666;
