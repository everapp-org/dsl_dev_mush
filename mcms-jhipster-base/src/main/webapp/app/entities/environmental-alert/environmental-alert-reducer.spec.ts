...
import reducer, {
  ...
  reset,
  updateEntity,
} from './environmental-alert.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENVIRONMENTALALERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENVIRONMENTALALERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENVIRONMENTALALERT actions', async () => {
      const arg = { id: 15730 };
    ...
    it('dispatches UPDATE_ENVIRONMENTALALERT actions', async () => {
      const arg = { id: 15730 };
    ...
    it('dispatches PARTIAL_UPDATE_ENVIRONMENTALALERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENVIRONMENTALALERT actions', async () => {
      const arg = 42666;
