...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SALESORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SALESORDER actions', async () => {
      const arg = { id: 16986 };
    ...
    it('dispatches UPDATE_SALESORDER actions', async () => {
      const arg = { id: 16986 };
    ...
    it('dispatches PARTIAL_UPDATE_SALESORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SALESORDER actions', async () => {
      const arg = 42666;
