...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLUSHCYCLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FLUSHCYCLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FLUSHCYCLE actions', async () => {
      const arg = { id: 25029 };
    ...
    it('dispatches UPDATE_FLUSHCYCLE actions', async () => {
      const arg = { id: 25029 };
    ...
    it('dispatches PARTIAL_UPDATE_FLUSHCYCLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FLUSHCYCLE actions', async () => {
      const arg = 42666;
