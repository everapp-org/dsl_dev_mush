...
import static com.mcms.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    private static final QualityGrade DEFAULT_DEFAULT_GRADE = QualityGrade.A_PREMIUM;
    private static final QualityGrade UPDATED_DEFAULT_GRADE = QualityGrade.B_STANDARD;

    private static final BigDecimal DEFAULT_DEFAULT_WEIGHT_KG = new BigDecimal(1);
    private static final BigDecimal UPDATED_DEFAULT_WEIGHT_KG = new BigDecimal(2);

    private static final BigDecimal DEFAULT_DEFAULT_PRICE_PER_KG = new BigDecimal(1);
    private static final BigDecimal UPDATED_DEFAULT_PRICE_PER_KG = new BigDecimal(2);
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .defaultGrade(DEFAULT_DEFAULT_GRADE)
            .defaultWeightKg(DEFAULT_DEFAULT_WEIGHT_KG)
            .defaultPricePerKg(DEFAULT_DEFAULT_PRICE_PER_KG)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product updatedProduct = new Product()
            ...
            .defaultGrade(UPDATED_DEFAULT_GRADE)
            .defaultWeightKg(UPDATED_DEFAULT_WEIGHT_KG)
            .defaultPricePerKg(UPDATED_DEFAULT_PRICE_PER_KG)
        ...
        updatedProduct.setStrain(strain);
    ...
    @Test
    @Transactional
    void checkDefaultGradeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        product.setDefaultGrade(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].defaultGrade").value(hasItem(DEFAULT_DEFAULT_GRADE.toString())))
            .andExpect(jsonPath("$.[*].defaultWeightKg").value(hasItem(sameNumber(DEFAULT_DEFAULT_WEIGHT_KG))))
            .andExpect(jsonPath("$.[*].defaultPricePerKg").value(hasItem(sameNumber(DEFAULT_DEFAULT_PRICE_PER_KG))))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.defaultGrade").value(DEFAULT_DEFAULT_GRADE.toString()))
            .andExpect(jsonPath("$.defaultWeightKg").value(sameNumber(DEFAULT_DEFAULT_WEIGHT_KG)))
            .andExpect(jsonPath("$.defaultPricePerKg").value(sameNumber(DEFAULT_DEFAULT_PRICE_PER_KG)))
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.defaultPricePerKg(UPDATED_DEFAULT_PRICE_PER_KG);
