...
import static com.mcms.domain.CustomerAsserts.*;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_DELIVERY_PREFERENCE = "AAAAAAAAAA";
    private static final String UPDATED_DELIVERY_PREFERENCE = "BBBBBBBBBB";
    ...
    public static Customer createEntity() {
        return new Customer()
            ...
            .deliveryPreference(DEFAULT_DELIVERY_PREFERENCE)
    ...
    public static Customer createUpdatedEntity() {
        return new Customer()
            ...
            .deliveryPreference(UPDATED_DELIVERY_PREFERENCE)
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].deliveryPreference").value(hasItem(DEFAULT_DELIVERY_PREFERENCE)))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.deliveryPreference").value(DEFAULT_DELIVERY_PREFERENCE))
