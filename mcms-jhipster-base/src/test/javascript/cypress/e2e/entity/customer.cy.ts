...
describe('Customer e2e test', () => {
  ...
  const customerSample = { name: 'terribly', active: true };
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      ...
      cy.get(`[data-cy="contactPerson"]`).type('pish');
      cy.get(`[data-cy="contactPerson"]`).should('have.value', 'pish');

      cy.get(`[data-cy="email"]`).type('Glennie15@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Glennie15@hotmail.com');

      cy.get(`[data-cy="phone"]`).type('453-914-3579 x834');
      cy.get(`[data-cy="phone"]`).should('have.value', '453-914-3579 x834');
      ...
      cy.get(`[data-cy="deliveryPreference"]`).type('yum during');
      cy.get(`[data-cy="deliveryPreference"]`).should('have.value', 'yum during');

      cy.get(`[data-cy="paymentTerms"]`).type('stingy');
      cy.get(`[data-cy="paymentTerms"]`).should('have.value', 'stingy');
