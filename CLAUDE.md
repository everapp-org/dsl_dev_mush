...
This command **requires** the project directory as an argument via `/home/gpetrov/src/dsl_dev_mush`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/app_spec.txt` and `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/initializer_prompt.md`

If `/home/gpetrov/src/dsl_dev_mush` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/`!
>
> **Files created:**
> - `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/app_spec.txt`
> - `/home/gpetrov/src/dsl_dev_mush/.autoforge/prompts/initializer_prompt.md`
>
